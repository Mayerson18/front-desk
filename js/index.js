...
$a.hover( function(e){
  ...
  $('.content-title').text(data[id].title);
  $('.content-body').text(data[id].content);
  $('.content-sub-title').text(data[id].subTitle);
  var li = data[id].functions.map( e => `<li class="function">${e}</li>`);
  $('#img').addClass('animated fadeInRight').attr("src", data[id].url);
